package com.android.kuzmin.tetris.models

import android.graphics.Point
import com.android.kuzmin.tetris.constants.CellConstants
import com.android.kuzmin.tetris.constants.FieldConstants;
import com.android.kuzmin.tetris.helper.array2dOfByte;
import com.android.kuzmin.tetris.storage.AppPreferences;
...
class AppModel {
    ...
    private fun resetField(ephemeralCelOnly: Boolean = true) {
        for (i in 0 until FieldConstants.ROW_COUNT.value) {
            (0 until FieldConstants.COLUMN_COUNT.value)
                .filter { !ephemeralCelOnly || field[i][it] ==
